...
#ifndef APPLICATION_BROWSER_INSTALLER_TIZEN_PACKAGE_INSTALLER_H_
#define APPLICATION_BROWSER_INSTALLER_TIZEN_PACKAGE_INSTALLER_H_
...
#endif  // APPLICATION_BROWSER_INSTALLER_TIZEN_PACKAGE_INSTALLER_H_
